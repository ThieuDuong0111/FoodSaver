...
@lazySingleton
class ProductByStoreUsecase extends UseCaseHandleFailure<List<ProductEntity>, int> {
  ProductByStoreUsecase(this._productRepository);

  final ProductRepository _productRepository;

  @override
  Future<Either<Failure, List<ProductEntity>>> call(int params) {
    return _productRepository.productByStorePage(params);
  }
}
